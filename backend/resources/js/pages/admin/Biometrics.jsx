...
export default function Biometrics() {
    ...
    const load = async () => {
        setLoading(true);
        try { const response = await api.get('/admin/biometrics', { params: { search, page: currentPage } }); setPagination(response.data); setItems(response.data.data || []); }
