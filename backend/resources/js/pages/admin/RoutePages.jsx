...
export function OrganizationSettingsPage() {
    ...
    useEffect(()=>{api.get('/app-config').then(r=>setConfig(r.data?.data || r.data)).finally(()=>setLoading(false));},[]);
