...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/device-binding', builder: (_, __) => const DeviceBindingScreen()),
    ...
    GoRoute(path: '/app/attendance/check-in', builder: (_, __) => const FaceCheckInScreen()),
    GoRoute(path: '/app/attendance/success', builder: (_, __) => const CheckInSuccessScreen()),
    GoRoute(path: '/app/attendance/detail', builder: (_, __) => const AttendanceDetailScreen()),
    GoRoute(path: '/app/attendance/report', builder: (_, __) => const AttendanceReportScreen()),
    GoRoute(path: '/app/attendance/dispute', builder: (_, __) => const AttendanceDisputeScreen()),

    GoRoute(path: '/app/schedule/shifts', builder: (_, __) => const ShiftScheduleScreen()),
    GoRoute(path: '/app/habits', builder: (_, __) => const HabitTrackerScreen()),
    GoRoute(path: '/app/habits/new', builder: (_, __) => const HabitFormScreen()),
    GoRoute(path: '/app/habits/detail', builder: (_, __) => const HabitDetailScreen()),

    GoRoute(path: '/app/leave/new', builder: (_, __) => const LeaveRequestFormScreen()),
    GoRoute(path: '/app/leave/detail', builder: (_, __) => const LeaveDetailScreen()),
    GoRoute(path: '/app/leave/approval-detail', builder: (_, __) => const ApprovalDetailScreen()),

    GoRoute(path: '/app/claims', builder: (_, __) => const ClaimListScreen()),
    GoRoute(path: '/app/claims/new', builder: (_, __) => const ClaimSubmissionScreen()),
    GoRoute(path: '/app/claims/detail', builder: (_, __) => const ClaimDetailScreen()),

    GoRoute(path: '/app/payslip', builder: (_, __) => const PayslipListScreen()),
    GoRoute(path: '/app/payslip/detail', builder: (_, __) => const PayslipDetailScreen()),

    GoRoute(path: '/app/calendar', builder: (_, __) => const CompanyCalendarScreen()),
    GoRoute(path: '/app/calendar/event', builder: (_, __) => const EventDetailScreen()),
    GoRoute(path: '/app/announcements', builder: (_, __) => const AnnouncementsScreen()),
    GoRoute(path: '/app/announcements/detail', builder: (_, __) => const AnnouncementDetailScreen()),
    ...
    GoRoute(path: '/admin/hr-dashboard', builder: (_, __) => const HREmployeeDashboardScreen()),
    GoRoute(path: '/admin/employees', builder: (_, __) => const EmployeeManagementScreen()),
    GoRoute(path: '/admin/employees/detail', builder: (_, __) => const EmployeeDetailAdminScreen()),
    GoRoute(path: '/admin/employees/onboarding', builder: (_, __) => const EmployeeOnboardingAdminScreen()),
    GoRoute(path: '/admin/reports', builder: (_, __) => const AttendanceReportAdminScreen()),
    GoRoute(path: '/admin/attendance-flags', builder: (_, __) => const AttendanceFlagReviewScreen()),
    GoRoute(path: '/admin/approvals', builder: (_, __) => const LeaveRequestAdminScreen()), // Using LeaveRequestAdminScreen for generic admin approval demo
    GoRoute(path: '/admin/claims', builder: (_, __) => const ClaimDetailAdminScreen()),
    GoRoute(path: '/manager/approvals', builder: (_, __) => const TeamApprovalsScreen()),
    GoRoute(path: '/manager/team-performance', builder: (_, __) => const TeamPerformanceScreen()),
    GoRoute(path: '/admin/payroll-config', builder: (_, __) => const PayrollConfigurationScreen()),
    GoRoute(path: '/admin/payroll', builder: (_, __) => const PayrollRunDetailScreen()),
    GoRoute(path: '/admin/shifts', builder: (_, __) => const ShiftTemplatesScreen()), // Using this as entry point for shifts for now
    GoRoute(path: '/admin/shift-assignments', builder: (_, __) => const ShiftAssignmentGridScreen()),
    GoRoute(path: '/admin/announcements/new', builder: (_, __) => const CreateAnnouncementScreen()),
    GoRoute(path: '/admin/org-settings', builder: (_, __) => const OrganizationSettingsScreen()),
    GoRoute(path: '/admin/department-analytics', builder: (_, __) => const DepartmentAnalyticsScreen()),
    GoRoute(path: '/admin/export', builder: (_, __) => const ExportCenterScreen()),
    ...
    GoRoute(path: '/admin/events', builder: (_, __) => const CompanyEventsManagerScreen()),

    // Main Shell
    StatefulShellRoute.indexedStack(
      builder: (context, state, navigationShell) => BottomNavShell(navigationShell: navigationShell),
      branches: [
        StatefulShellBranch(routes: [GoRoute(path: '/app/home', builder: (_, __) => const HomeDashboardScreen())]),
        StatefulShellBranch(routes: [GoRoute(path: '/app/attendance', builder: (_, __) => const AttendanceHistoryScreen())]),
        StatefulShellBranch(routes: [GoRoute(path: '/app/leave', builder: (_, __) => const ApprovalInboxScreen())]), // Swapped to Inbox for better default manager feel, but could be LeaveRequestsScreen. Let's use ApprovalInboxScreen
        StatefulShellBranch(routes: [GoRoute(path: '/app/profile', builder: (_, __) => const UserProfileScreen())]),
      ],
    ),
  ],
);
