  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text('Slip ${payslip.periodLabel}',
      ...
      body: SingleChildScrollView(
          ...
          child:
            ...
            InfoCard(
              ...
              Text('GAJI BERSIH',
                  style: TextStyle(
                      ...
                      letterSpacing: 0.5)),
              SizedBox(height: 4.h),
              Text(currencyFormatter.format(payslip.netSalary),
                  style: Theme.of(context).textTheme.displaySmall?.copyWith(
                      color: AppColors.primaryContainer,
                      fontWeight: FontWeight.bold)),
              SizedBox(height: 4.h),
              Text('Periode: ${payslip.periodLabel}',
                  style: TextStyle(
            ...
            InfoCard(
                ...
                child: Column(children: [
                  if (payslip.earningsBreakdown != null &&
                      payslip.earningsBreakdown!.isNotEmpty)
                  ...
                  _Row(
                      ...
                      value: currencyFormatter.format(payslip.grossSalary),
                      isBold: true),
                ])),
            SizedBox(height: 24.h),
            ...
            InfoCard(
                ...
                child: Column(children: [
                  if (payslip.deductionsBreakdown != null &&
                      payslip.deductionsBreakdown!.isNotEmpty)
                      ...
                      return Column(
                        children: [
                          _Row(
                              label: e.key,
                              value:
                                  '- ${currencyFormatter.format(num.tryParse(e.value.toString()) ?? 0)}'),
                          Divider(
                              height: 16.h,
                              color: AppColors.outlineVariant
                                  .withValues(alpha: 0.3)),
                  ...
                  _Row(
                      ...
                      value:
                          '- ${currencyFormatter.format(payslip.totalDeductions)}',
                      isBold: true),
                ])),
          ])),
    );
