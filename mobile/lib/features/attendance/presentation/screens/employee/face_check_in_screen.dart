  ...
  void _onPhotoCaptured(XFile? file) async {
    if (file != null) {
      ...
      if (registeredEmbeddingStr != null) {
        ...
        final registeredEmbedding = jsonList.map((e) => e as double).toList();
        faceMatchScore = FaceMatcherService.calculateCosineSimilarity(_liveEmbedding, registeredEmbedding);
      }
